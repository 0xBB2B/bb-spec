...
| **bb-spec-workflow** _(核心功能)_ | spec → plan → exec → test-webview / test-api → review → revise → git-push、init 反向 spec、doc-update 全仓一致性维护 + 11 个 subagent | `/plugin install bb-spec-workflow@0xbb2b` |
