...
| **bb-spec-workflow** _(核心功能)_ | spec → plan → exec → test-webview / test-api → review → revise → git-push、git-clone 一次性初始化、init 反向 spec、doc-update 全儲存庫一致性維護 + 12 個 subagent | `/plugin install bb-spec-workflow@0xbb2b` |
